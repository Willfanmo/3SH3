...
int main(int argc, char *argv[]) {
    ...
    // Track which requests were already processed
    ...
    // Prepare a sorted list of requests for the following algorithms 
    ...
    // Sorted array now holds the request values in ascending order
    // Model 0-299 range
